...
updates:    
    changed .csv header names to be consistent
    cleaned up code and comments

to-dos:
    switch headers for wind and solar capacity factors to be consistent with order of results?
    clarify "wind capacity (kW)" and "solar capacity (kW)" - see notes
...
def save_vector_results_as_csv(
    ...
    for idx in range(len(result_list)):
        ...
        header_list += ['dispatch curtailment (kW)']
